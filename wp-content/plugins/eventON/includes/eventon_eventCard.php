			...
			// learnmore ICS and close button
				case 'learnmoreICS':				
					...
					// Initial 
						...
						$unix_start = $object->estart + $customoffset;
						$unix_end = $object->eend + $customoffset;

						$__ics_url =admin_url('admin-ajax.php').'?action=eventon_ics_download&amp;event_id='.$object->event_id.'&amp;sunix='.$unix_start.'&amp;eunix='.$unix_end;
