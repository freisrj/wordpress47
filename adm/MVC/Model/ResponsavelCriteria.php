...
require_once("DAO/ResponsavelCriteriaDAO.php");

/**
 * The ResponsavelCriteria class extends ResponsavelDAOCriteria and is used
 ...
 * @version 1.0
 */
class ResponsavelCriteria extends ResponsavelCriteriaDAO
{
