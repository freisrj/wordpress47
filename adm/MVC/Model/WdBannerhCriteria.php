...
require_once("DAO/WdBannerhCriteriaDAO.php");

/**
 * The WdBannerhCriteria class extends WdBannerhDAOCriteria and is used
 ...
 * @version 1.0
 */
class WdBannerhCriteria extends WdBannerhCriteriaDAO
{
