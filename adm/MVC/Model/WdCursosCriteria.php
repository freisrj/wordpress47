...
require_once("DAO/WdCursosCriteriaDAO.php");

/**
 * The WdCursosCriteria class extends WdCursosDAOCriteria and is used
 ...
 * @version 1.0
 */
class WdCursosCriteria extends WdCursosCriteriaDAO
{
