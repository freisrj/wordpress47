...
require_once("DAO/WdPesquisaCriteriaDAO.php");

/**
 * The WdPesquisaCriteria class extends WdPesquisaDAOCriteria and is used
 ...
 * @version 1.0
 */
class WdPesquisaCriteria extends WdPesquisaCriteriaDAO
{
