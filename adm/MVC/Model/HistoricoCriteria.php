...
require_once("DAO/HistoricoCriteriaDAO.php");

/**
 * The HistoricoCriteria class extends HistoricoDAOCriteria and is used
 ...
 * @version 1.0
 */
class HistoricoCriteria extends HistoricoCriteriaDAO
{
