...
require_once("DAO/AtendimentoCriteriaDAO.php");

/**
 * The AtendimentoCriteria class extends AtendimentoDAOCriteria and is used
 ...
 * @version 1.0
 */
class AtendimentoCriteria extends AtendimentoCriteriaDAO
{
