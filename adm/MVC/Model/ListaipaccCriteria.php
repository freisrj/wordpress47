...
require_once("DAO/ListaipaccCriteriaDAO.php");

/**
 * The ListaipaccCriteria class extends ListaipaccDAOCriteria and is used
 ...
 * @version 1.0
 */
class ListaipaccCriteria extends ListaipaccCriteriaDAO
{
