...
require_once("DAO/WdValorcursosproCriteriaDAO.php");

/**
 * The WdValorcursosproCriteria class extends WdValorcursosproDAOCriteria and is used
 ...
 * @version 1.0
 */
class WdValorcursosproCriteria extends WdValorcursosproCriteriaDAO
{
