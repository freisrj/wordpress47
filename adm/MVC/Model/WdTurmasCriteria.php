...
require_once("DAO/WdTurmasCriteriaDAO.php");

/**
 * The WdTurmasCriteria class extends WdTurmasDAOCriteria and is used
 ...
 * @version 1.0
 */
class WdTurmasCriteria extends WdTurmasCriteriaDAO
{
