...
require_once("DAO/PagamentoCriteriaDAO.php");

/**
 * The PagamentoCriteria class extends PagamentoDAOCriteria and is used
 ...
 * @version 1.0
 */
class PagamentoCriteria extends PagamentoCriteriaDAO
{
