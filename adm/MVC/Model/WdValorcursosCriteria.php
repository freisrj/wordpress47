...
require_once("DAO/WdValorcursosCriteriaDAO.php");

/**
 * The WdValorcursosCriteria class extends WdValorcursosDAOCriteria and is used
 ...
 * @version 1.0
 */
class WdValorcursosCriteria extends WdValorcursosCriteriaDAO
{
