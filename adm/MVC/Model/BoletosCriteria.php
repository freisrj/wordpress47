...
require_once("DAO/BoletosCriteriaDAO.php");

/**
 * The BoletosCriteria class extends BoletosDAOCriteria and is used
 ...
 * @version 1.0
 */
class BoletosCriteria extends BoletosCriteriaDAO
{
