...
require_once("DAO/WdCadastroCriteriaDAO.php");

/**
 * The WdCadastroCriteria class extends WdCadastroDAOCriteria and is used
 ...
 * @version 1.0
 */
class WdCadastroCriteria extends WdCadastroCriteriaDAO
{
