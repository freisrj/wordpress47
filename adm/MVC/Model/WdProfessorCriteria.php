...
require_once("DAO/WdProfessorCriteriaDAO.php");

/**
 * The WdProfessorCriteria class extends WdProfessorDAOCriteria and is used
 ...
 * @version 1.0
 */
class WdProfessorCriteria extends WdProfessorCriteriaDAO
{
