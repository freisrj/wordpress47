...
require_once("DAO/IndicacaoCriteriaDAO.php");

/**
 * The IndicacaoCriteria class extends IndicacaoDAOCriteria and is used
 ...
 * @version 1.0
 */
class IndicacaoCriteria extends IndicacaoCriteriaDAO
{
