...
require_once("DAO/WdContatoCriteriaDAO.php");

/**
 * The WdContatoCriteria class extends WdContatoDAOCriteria and is used
 ...
 * @version 1.0
 */
class WdContatoCriteria extends WdContatoCriteriaDAO
{
