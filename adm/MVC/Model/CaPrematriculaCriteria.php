...
require_once("DAO/CaPrematriculaCriteriaDAO.php");

/**
 * The CaPrematriculaCriteria class extends CaPrematriculaDAOCriteria and is used
 ...
 * @version 1.0
 */
class CaPrematriculaCriteria extends CaPrematriculaCriteriaDAO
{
