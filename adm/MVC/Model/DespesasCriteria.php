...
require_once("DAO/DespesasCriteriaDAO.php");

/**
 * The DespesasCriteria class extends DespesasDAOCriteria and is used
 ...
 * @version 1.0
 */
class DespesasCriteria extends DespesasCriteriaDAO
{
