...
require_once("DAO/EstadosCriteriaDAO.php");

/**
 * The EstadosCriteria class extends EstadosDAOCriteria and is used
 ...
 * @version 1.0
 */
class EstadosCriteria extends EstadosCriteriaDAO
{
