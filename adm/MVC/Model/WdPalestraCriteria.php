...
require_once("DAO/WdPalestraCriteriaDAO.php");

/**
 * The WdPalestraCriteria class extends WdPalestraDAOCriteria and is used
 ...
 * @version 1.0
 */
class WdPalestraCriteria extends WdPalestraCriteriaDAO
{
