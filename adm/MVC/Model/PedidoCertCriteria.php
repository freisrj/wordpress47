...
require_once("DAO/PedidoCertCriteriaDAO.php");

/**
 * The PedidoCertCriteria class extends PedidoCertDAOCriteria and is used
 ...
 * @version 1.0
 */
class PedidoCertCriteria extends PedidoCertCriteriaDAO
{
