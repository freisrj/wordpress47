...
require_once("DAO/PagamentosCriteriaDAO.php");

/**
 * The PagamentosCriteria class extends PagamentosDAOCriteria and is used
 ...
 * @version 1.0
 */
class PagamentosCriteria extends PagamentosCriteriaDAO
{
