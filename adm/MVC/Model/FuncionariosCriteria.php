...
require_once("DAO/FuncionariosCriteriaDAO.php");

/**
 * The FuncionariosCriteria class extends FuncionariosDAOCriteria and is used
 ...
 * @version 1.0
 */
class FuncionariosCriteria extends FuncionariosCriteriaDAO
{
