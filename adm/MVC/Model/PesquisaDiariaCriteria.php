...
require_once("DAO/PesquisaDiariaCriteriaDAO.php");

/**
 * The PesquisaDiariaCriteria class extends PesquisaDiariaDAOCriteria and is used
 ...
 * @version 1.0
 */
class PesquisaDiariaCriteria extends PesquisaDiariaCriteriaDAO
{
