...
require_once("DAO/SArtigosCriteriaDAO.php");

/**
 * The SArtigosCriteria class extends SArtigosDAOCriteria and is used
 ...
 * @version 1.0
 */
class SArtigosCriteria extends SArtigosCriteriaDAO
{
