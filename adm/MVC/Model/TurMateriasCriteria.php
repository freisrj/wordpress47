...
require_once("DAO/TurMateriasCriteriaDAO.php");

/**
 * The TurMateriasCriteria class extends TurMateriasDAOCriteria and is used
 ...
 * @version 1.0
 */
class TurMateriasCriteria extends TurMateriasCriteriaDAO
{
