...
require_once("DAO/HistoricoAlunoCriteriaDAO.php");

/**
 * The HistoricoAlunoCriteria class extends HistoricoAlunoDAOCriteria and is used
 ...
 * @version 1.0
 */
class HistoricoAlunoCriteria extends HistoricoAlunoCriteriaDAO
{
