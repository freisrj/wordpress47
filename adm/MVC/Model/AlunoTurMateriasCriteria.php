...
require_once("DAO/AlunoTurMateriasCriteriaDAO.php");

/**
 * The AlunoTurMateriasCriteria class extends AlunoTurMateriasDAOCriteria and is used
 ...
 * @version 1.0
 */
class AlunoTurMateriasCriteria extends AlunoTurMateriasCriteriaDAO
{
