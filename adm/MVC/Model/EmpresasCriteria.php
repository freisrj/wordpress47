...
require_once("DAO/EmpresasCriteriaDAO.php");

/**
 * The EmpresasCriteria class extends EmpresasDAOCriteria and is used
 ...
 * @version 1.0
 */
class EmpresasCriteria extends EmpresasCriteriaDAO
{
