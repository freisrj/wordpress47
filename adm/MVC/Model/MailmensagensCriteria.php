...
require_once("DAO/MailmensagensCriteriaDAO.php");

/**
 * The MailmensagensCriteria class extends MailmensagensDAOCriteria and is used
 ...
 * @version 1.0
 */
class MailmensagensCriteria extends MailmensagensCriteriaDAO
{
