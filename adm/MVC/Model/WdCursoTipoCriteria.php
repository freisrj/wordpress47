...
require_once("DAO/WdCursoTipoCriteriaDAO.php");

/**
 * The WdCursoTipoCriteria class extends WdCursoTipoDAOCriteria and is used
 ...
 * @version 1.0
 */
class WdCursoTipoCriteria extends WdCursoTipoCriteriaDAO
{
