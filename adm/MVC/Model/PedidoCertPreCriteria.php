...
require_once("DAO/PedidoCertPreCriteriaDAO.php");

/**
 * The PedidoCertPreCriteria class extends PedidoCertPreDAOCriteria and is used
 ...
 * @version 1.0
 */
class PedidoCertPreCriteria extends PedidoCertPreCriteriaDAO
{
