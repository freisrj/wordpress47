...
require_once("DAO/UnidadesCriteriaDAO.php");

/**
 * The UnidadesCriteria class extends UnidadesDAOCriteria and is used
 ...
 * @version 1.0
 */
class UnidadesCriteria extends UnidadesCriteriaDAO
{
