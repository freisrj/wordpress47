...
require_once("DAO/MailmarketingCriteriaDAO.php");

/**
 * The MailmarketingCriteria class extends MailmarketingDAOCriteria and is used
 ...
 * @version 1.0
 */
class MailmarketingCriteria extends MailmarketingCriteriaDAO
{
