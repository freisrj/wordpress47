...
<head>
  ...
  <title>Adminstrador WDinfo | Log in</title>
...
<div class="login-box">
  <div class="login-logo">
    <img src="images/nlogocomp.png" width="300" >
  </div>
  <!-- /.login-logo -->
  <div class="login-box-body">
    <p class="login-box-msg">Adminstrador WDinfo</p>

    <!--<form action="../../index2.html" method="post">-->
    <form action="index1.php" method="GET">
      <div class="form-group has-feedback">
        <input type="text" name="login" class="form-control" placeholder="Entre com o seu login">
        <span class="glyphicon glyphicon-text form-control-feedback"></span>
      </div>
      <div class="form-group has-feedback">
        <input type="password" name="senha" class="form-control" placeholder="Entre com o sua senha">
