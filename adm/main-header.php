      <header class="main-header">
        ...
        <a href="\Admin\index.php" class="logo">
          ...
          <span class="logo-lg"><b>Logo Sistema</b></span>
        </a>
                  ...
                  <li>
                    ...
                    <ul class="menu">
                      ...
                      <li>
                        <a href="#">
                          <div class="pull-left">
                            <img src="/phpMVC/dist/img/user3-128x128.jpg" class="img-circle" alt="User Image">
                          </div>
                          <h4>
              ...
              <li class="dropdown user user-menu">
                <a href="#" class="dropdown-toggle" data-toggle="dropdown">
                  <!--<img src="dist/img/user2-160x160.jpg" class="user-image" alt="User Image">-->
              	  <img src="<?php echo MAINURL.$_SESSION ['Imagem_path']; ?>" class="user-image" alt="User Image">
                ...
                <ul class="dropdown-menu">
                  ...
                  <li class="user-footer">
                    <div class="pull-left">
                      <a href="\Admin\pages\perfil-usuario\profile.php" class="btn btn-default btn-flat">Perfil de usuário</a>
                    </div>
